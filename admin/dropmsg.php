...
<div class="container">
    ...
    <div class="col s12 m12 #fce4ec pink lighten-5">
        <h5 class="z-depth-3 center"><b>Successfully Droped Exercise !!</b></h5>
    </div>
    <br>
    <br>
    <div class="row">
    ...
    <button onclick="window.location.href='new_exercise.php'" class="btn waves-effect waves-light #ba68c8 purple lighten-2" type="submit" name="action">Create new exercise
       </button>
        </div>
